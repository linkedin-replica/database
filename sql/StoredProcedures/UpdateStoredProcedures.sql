...
DELIMITER $$
CREATE PROCEDURE `edit_password`( user_id varchar(25),  new_password varchar(512))
  BEGIN
...
DELIMITER $$
CREATE PROCEDURE `accept_friend_request`( user_id1 varchar(25), user_id2 varchar(25))
  BEGIN

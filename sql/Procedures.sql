...
DELIMITER $$
CREATE PROCEDURE `view_applied_jobs`(id int)
  BEGIN
...
DELIMITER $$
CREATE PROCEDURE `view_jobs_for_company`(id_company int)
  BEGIN
...
DELIMITER $$
CREATE PROCEDURE `delete_company`(id_company int)
  BEGIN
...
DELIMITER $$
CREATE PROCEDURE `delete_job`(id_job int)
  BEGIN
...
DELIMITER $$
CREATE PROCEDURE `delete_job_needs_skill`(job_id_in int, skill_id_in int)
  BEGIN
...
DELIMITER $$
CREATE PROCEDURE `delete_skill`(id_skill int)
  BEGIN
...
DELIMITER $$
CREATE PROCEDURE `delete_user_apply_for_job`(user_id_in int,  job_id_in int)
  BEGIN
...
DELIMITER $$
CREATE PROCEDURE `delete_user_blocks_user`(blocking_user_id_in int, blocked_user_id_in int)
  BEGIN
...
DELIMITER $$
CREATE PROCEDURE `delete_user_friend_with_user`(user1_id_in int, user2_id_in int)
  BEGIN
...
DELIMITER $$
CREATE PROCEDURE `delete_user_has_skill`(user_id_in int, skill_id_in int)
  BEGIN
